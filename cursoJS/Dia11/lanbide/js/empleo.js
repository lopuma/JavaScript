...
async function getMunicipios() {
    let respuesta = await fetch("api/index-empleo.php?comando=listaMunis");
...
async function buscar() {
    ...
    let respuesta = await fetch("api/index-empleo.php?comando=buscar&municipio=" + municipio.value + "&termino=" + termino.value);
